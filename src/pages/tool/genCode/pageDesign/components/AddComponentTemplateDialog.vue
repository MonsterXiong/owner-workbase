...
<script>
import { quickGenCategoryType, quickGenComponentTemplate } from '../../../../../services/database';
      ...
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          ...
          if (this.formData.type == 'pageTemplate') {
            await quickGenComponentTemplate(this.formData)
          } else  if (this.formData.type == 'pageCategoryTemplate'){
            await quickGenCategoryType(this.formData)
          }
          // this.onDialogClose()
