<template>
  <div class="common-page gen-project-page">
    <BaseList title="数据池" subContentKey="databaseType" :data="poolList" :defaultProps="poolProps" @change="onPoolChange"> </BaseList>
    <BaseList title="数据库" subContentKey="comment" :data="currentDatabaseList" :defaultProps="databaseProps" @change="onDatabseChange"></BaseList>
    <BaseList title="数据库表" subContentKey="comment" :data="currentTableList" :defaultProps="tableProps" @change="onTableChange"></BaseList>
...
export default {
  ...
  methods: {
    ...
    async onPoolChange(poolId) {
      ...
      this.currentDatabaseList = this.databaseList.filter((item) => item.poolId == poolId)
    },
    onDatabseChange(databaseId) {
      this.currentActiveDatabaseId = databaseId
      this.currentTableList = this.tableList.filter((item) => item.databaseId == databaseId)
    },
