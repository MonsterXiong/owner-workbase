<template>
  <div class="common-page">
    <SplitLayout :rightPanelSize="3" :projectId="projectId" leftTitle="列表" title="组织图" rightTitle="表单">
      <template #left>
